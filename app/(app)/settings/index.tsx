 ...
 * FIX: Corrected absolute routing paths .
 */
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        ...
        >
          <Animated.View entering={FadeInDown.delay(stagger(1)).springify()}>
            {/* FIX: Routing directly to /settings/profile */}
            <TouchableOpacity
              activeOpacity={0.9}
              onPress={() => {
                if (Platform.OS !== 'web') Haptics.selectionAsync();
                ...
                <View style={styles.profileRow}>
                  ...
                  <View style={styles.profileTextWrap}>
                    <Text style={styles.profileName} numberOfLines={1}>
                      {profile?.full_name || profile?.username || 'Operator'}
                    </Text>
          ...
          <Animated.View entering={FadeInDown.delay(stagger(4)).springify()}>
            ...
            <GlassCard intensity="medium" style={styles.menuGroup}>
              {/* FIX: Routing directly to /settings/change-password */}
              <SettingsMenuItem
                icon={Lock}
                ...
                color={NORTH_THEME.colors.status.success}
              />
              {/* FIX: Routing directly to /settings/biometric */}
              <SettingsMenuItem
                icon={Fingerprint}
